  ...
  return (
    <div>
      <div
        ...
        className="fixed bottom-4 right-4 bg-red-600 text-white rounded-full p-4 cursor-pointer shadow-lg hover:bg-red-700 transition-all animate-shake"
      >
        <GrContact size={24} />
      </div>
